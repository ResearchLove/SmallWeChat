...
@interface ChatBoxMoreView() <UIScrollViewDelegate>
...
@implementation ChatBoxMoreView

-(id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        [self setBackgroundColor:DEFAULT_CHAT_BACKGROUND_COLOR];
...
-(void)setItems:(NSMutableArray *)items
{
    ...
    int i = 0,page = 0;
    for (ChatBoxMoreItem *item in _items) {
...
- (void) didSelectedItem:(ChatBoxMoreItem *)sender
{
