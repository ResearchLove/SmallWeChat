...
@implementation ChatBoxFaceMenuView
...
-(void)setFaceGroupArray:(NSMutableArray *)faceGroupArray
{
    ...
    float x = 0;
    int i = 0;
    for (FaceGroupModel *group in faceGroupArray) {
...
-(void)buttonDown:(UIButton *)sender
{
    ...
    if (sender.tag == -1) {
        ...
        if ([[_faceGroupArray objectAtIndex:sender.tag] faceType] == FaceTypeEmoji) {
